...
internal class MainDomainReducer @Inject constructor() :
    Reducer<MainEvent.Domain, MainDomainState, MainSideEffect> {
    ...
    private fun reduceOnLoadAppThemeNeeded(): Update<MainDomainState, MainSideEffect> {
        return Update.sideEffects(MainSideEffect.Domain.LoadAppTheme)
    }
